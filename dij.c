...
#include "abr.h"
#include "dijkstra.h"
  /* PARTIE 2 Ecrivez la fonction correspondant à cet algorithme DE DIKJ */
...
void dijkstra(Un_elem *liste_sta, Un_truc *sta_dep){
  ...
  int i;
  float tpsDeParcours;
  /* PARTIE 1 2NONC2 DE L4ALGO DE DOKJISTRA*/
...
/* PARTIE 3 reconstituer la liste des connexions correspondant
 au plus court chemin jusqu’à une station destination */
